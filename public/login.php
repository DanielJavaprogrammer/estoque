...
<head>
    ...
    <link rel="stylesheet" href="\estoque\assets\css\login.css">
</head>
        ...
        <div class="container">
            ...
            <div class="form">
                ...
                <form action="create_login.php" method="post">
                    ...
                    <input type="text" class="usu" id="usuario" name="usuario" required>
                    <label for="senha">Senha</label>
                    <input type="password" id="senha" name="senha" required>
                    <input type="submit" id="sendBtn" value="Acessar">
                </form>
            </div>
        </div>
    </main>

    <script src="\estoque\assets\scripts\"></script>
</body>
